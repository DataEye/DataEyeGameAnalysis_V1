...
#ifndef __DataEye__DCAgenth__
#define __DataEye__DCAgenth__
...
@interface DCVirtualCurrency : NSObject
...
@interface DCConfigParams : NSObject
...
@interface DCCardsGame : NSObject
